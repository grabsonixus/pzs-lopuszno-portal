    ...
    <div>
      ...
      <div className="mt-2 space-y-2">
        <div className="flex items-center">
          ...
          />
          <label htmlFor="url-type-subpage" className="ml-3 block text-sm font-medium text-gray-700">
            Wybierz podstronę
          </label>
        </div>
        <div className="flex items-center">
          <input
            ...
            className="h-4 w-4 text-indigo-600 border-gray-300"
          />
          <label htmlFor="url-type-custom" className="ml-3 block text-sm font-medium text-gray-700">
            Własny URL
          </label>
        </div>
      </div>
